...
export const createEmprendedora = async (req, res) => {
    const { nombre, numeroCliente, tips, semanas, ventaTotal, img } = req.body;

    try {
        const newEmprendedora = new Emprendedoras({ nombre, numeroCliente, tips, semanas, ventaTotal, img });
